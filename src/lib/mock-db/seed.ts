...
const zones: Zone[] = [
  { id: 'zone-1', tenantId: TENANT_ID, branchId: BRANCH_ID, name: 'Salão Interno', order: 1, color: '#3b82f6', active: true, createdAt: NOW, updatedAt: NOW },
  { id: 'zone-2', tenantId: TENANT_ID, branchId: BRANCH_ID, name: 'Varanda',       order: 2, color: '#10b981', active: true, createdAt: NOW, updatedAt: NOW },
  { id: 'zone-3', tenantId: TENANT_ID, branchId: BRANCH_ID, name: 'Barra',         order: 3, color: '#f59e0b', active: true, createdAt: NOW, updatedAt: NOW },
];

const tables: DbTable[] = [
  { id: 'table-1',   tenantId: TENANT_ID, branchId: BRANCH_ID, number: '1',   active: true,  validationCode: 'ABC1',  zoneId: 'zone-1', zoneName: 'Salão Interno', assignedWaiterName: 'Fernando', guestCount: 4, capacity: 4, status: 'READY_TO_SERVE',      createdAt: NOW, updatedAt: NOW },
  { id: 'table-2',   tenantId: TENANT_ID, branchId: BRANCH_ID, number: '2',   active: true,  validationCode: 'ABC2',  zoneId: 'zone-1', zoneName: 'Salão Interno', assignedWaiterName: 'Fernando', guestCount: 3, capacity: 4, status: 'WAITING_FOR_PAYMENT', createdAt: NOW, updatedAt: NOW },
  { id: 'table-3',   tenantId: TENANT_ID, branchId: BRANCH_ID, number: '3',   active: true,  validationCode: 'ABC3',  zoneId: 'zone-1', zoneName: 'Salão Interno', assignedWaiterName: 'Júnior',   guestCount: 2, capacity: 4, status: 'WAITING_FOR_PAYMENT', createdAt: NOW, updatedAt: NOW },
  { id: 'table-4',   tenantId: TENANT_ID, branchId: BRANCH_ID, number: '4',   active: true,  validationCode: 'ABC4',  zoneId: 'zone-1', zoneName: 'Salão Interno', assignedWaiterName: 'Júnior',   guestCount: 5, capacity: 6, status: 'ORDER_IN_PROGRESS',   createdAt: NOW, updatedAt: NOW },
  { id: 'table-5',   tenantId: TENANT_ID, branchId: BRANCH_ID, number: '5',   active: true,  validationCode: 'ABC5',  zoneId: 'zone-2', zoneName: 'Varanda',       assignedWaiterName: 'Rafael',   guestCount: 2, capacity: 2, status: 'WAITING_FOR_PAYMENT', createdAt: NOW, updatedAt: NOW },
  { id: 'table-6',   tenantId: TENANT_ID, branchId: BRANCH_ID, number: '6',   active: true,  validationCode: 'ABC6',  zoneId: 'zone-2', zoneName: 'Varanda',       assignedWaiterName: 'Rafael',   guestCount: 0, capacity: 4, status: 'EMPTY',               createdAt: NOW, updatedAt: NOW },
  { id: 'table-7',   tenantId: TENANT_ID, branchId: BRANCH_ID, number: '7',   active: true,  validationCode: 'ABC7',  zoneId: 'zone-2', zoneName: 'Varanda',       assignedWaiterName: 'Rafael',   guestCount: 3, capacity: 4, status: 'WAITING_FOR_KITCHEN', createdAt: NOW, updatedAt: NOW },
  { id: 'table-140', tenantId: TENANT_ID, branchId: BRANCH_ID, number: '140', active: true,  validationCode: 'QR140', zoneId: 'zone-3', zoneName: 'Barra',         assignedWaiterName: 'Fernando', guestCount: 1, capacity: 2, status: 'EMPTY',               createdAt: NOW, updatedAt: NOW },
];

const categories: DbCategory[] = [
  { id: 'cat-combos',       tenantId: TENANT_ID, branchId: BRANCH_ID, name: 'Combos',       imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=200&q=70', order: 0, active: true, createdAt: NOW, updatedAt: NOW },
  { id: 'cat-mais-pedidos', tenantId: TENANT_ID, branchId: BRANCH_ID, name: 'Mais pedidos', imageUrl: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=200&q=70', order: 1, active: true, createdAt: NOW, updatedAt: NOW },
  { id: 'cat-bebidas',      tenantId: TENANT_ID, branchId: BRANCH_ID, name: 'Bebidas',      imageUrl: 'https://images.unsplash.com/photo-1581636625402-29b2a704ef13?w=200&q=70', order: 2, active: true, createdAt: NOW, updatedAt: NOW },
  { id: 'cat-pratos',       tenantId: TENANT_ID, branchId: BRANCH_ID, name: 'Pratos',       imageUrl: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=200&q=70', order: 3, active: true, createdAt: NOW, updatedAt: NOW },
  { id: 'cat-sobremesas',   tenantId: TENANT_ID, branchId: BRANCH_ID, name: 'Sobremesas',   imageUrl: 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=200&q=70', order: 4, active: true, createdAt: NOW, updatedAt: NOW },
  { id: 'cat-cafeteria',    tenantId: TENANT_ID, branchId: BRANCH_ID, name: 'Cafeteria',    imageUrl: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=200&q=70', order: 5, active: true, createdAt: NOW, updatedAt: NOW },
  { id: 'cat-entradas',     tenantId: TENANT_ID, branchId: BRANCH_ID, name: 'Entradas',     imageUrl: 'https://images.unsplash.com/photo-1551782450-a2132b4ba21d?w=200&q=70', order: 6, active: true, createdAt: NOW, updatedAt: NOW },
];
...
const products: DbProduct[] = [
  ...
  { id: 'prod-agua-sem-gas', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-bebidas', name: 'Água sem gás', description: 'Garrafa 500ml', price: 5.5, imageUrl: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  ...
  { id: 'prod-espresso', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-cafeteria', name: 'Espresso duplo', description: 'Encorpado e aromático', price: 7.0, imageUrl: 'https://images.unsplash.com/photo-1510707577719-ae7c14805e3a?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-cappuccino', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-cafeteria', name: 'Cappuccino', description: 'Com leite vaporizado e canela, 200ml', price: 13.0, imageUrl: 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-bolo-cenoura', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-cafeteria', name: 'Bolo de cenoura', description: 'Fatia com cobertura de chocolate', price: 14.0, imageUrl: 'https://images.unsplash.com/photo-1621303837174-89787a7d4729?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  ...
  { id: 'prod-mousse-maracuja', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-sobremesas', name: 'Mousse de maracujá', description: 'Cremoso, com calda de maracujá fresco', price: 18.0, imageUrl: 'https://images.unsplash.com/photo-1571115177098-24ec42ed204d?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-brigadeiro', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-sobremesas', name: 'Brigadeiro gourmet', description: '3 unidades — sabores variados', price: 12.0, imageUrl: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-bolinho-bacalhau', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-entradas', name: 'Bolinho de bacalhau', description: '6 unidades crocantes', price: 36.0, imageUrl: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-coxinha', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-entradas', name: 'Coxinha de frango', description: '4 unidades crocantes', price: 22.0, imageUrl: 'https://images.unsplash.com/photo-1527324688151-0e627063f2b1?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-caldinho', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-entradas', name: 'Caldinho de feijão', description: 'Servido bem quente, 300ml', price: 14.0, imageUrl: 'https://images.unsplash.com/photo-1547592180-85f173990554?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  ...
  { id: 'prod-limonada', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-bebidas', name: 'Limonada suíça', description: 'Com leite condensado e hortelã, 400ml', price: 14.0, imageUrl: 'https://images.unsplash.com/photo-1621263764928-df1444c5e859?w=400&q=70', featured: true, available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-suco-maracuja', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-bebidas', name: 'Suco de maracujá', description: 'Natural com polpa fresca, 400ml', price: 13.0, imageUrl: 'https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=400&q=70', featured: true, available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-caipirinha', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-bebidas', name: 'Caipirinha clássica', description: 'Cachaça, limão e açúcar', price: 22.0, imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400&q=70', featured: true, available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-cerveja-heineken', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-bebidas', name: 'Cerveja Heineken', description: 'Long neck 330ml gelada', price: 16.0, imageUrl: 'https://images.unsplash.com/photo-1608270586620-248524c67de9?w=400&q=70', featured: true, available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-agua-com-gas', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-bebidas', name: 'Água com gás', description: 'Garrafa 500ml', price: 6.0, imageUrl: 'https://images.unsplash.com/photo-1598103442097-8b74394b95c3?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-guarana', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-bebidas', name: 'Guaraná Antarctica', description: 'Lata 350ml gelada', price: 8.9, imageUrl: 'https://images.unsplash.com/photo-1581636625402-29b2a704ef13?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-sprite', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-bebidas', name: 'Sprite', description: 'Lata 350ml gelada', price: 8.9, imageUrl: 'https://images.unsplash.com/photo-1625772299848-391b6a87d7b3?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-vinho-taca', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-bebidas', name: 'Vinho tinto taça', description: 'Vinho da casa, 150ml', price: 24.0, imageUrl: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-vitamina-banana', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-bebidas', name: 'Vitamina de banana', description: 'Com leite e mel, 400ml', price: 15.0, imageUrl: 'https://images.unsplash.com/photo-1553530666-ba11a7da3888?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-chá-gelado', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-bebidas', name: 'Chá gelado pêssego', description: 'Lata 350ml', price: 9.5, imageUrl: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=400&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-frango-brasa', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-pratos', name: 'Frango na brasa', description: 'Meia ave grelhada com farofa e vinagrete', price: 55.0, imageUrl: 'https://images.unsplash.com/photo-1532550907401-a500c9a57435?w=600&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-moqueca', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-pratos', name: 'Moqueca de peixe', description: 'Filé de peixe com leite de coco e dendê', price: 85.0, imageUrl: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  // Combos
  { id: 'prod-combo-duplo', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-combos', name: 'Combo Duplo', description: 'Isquinha de frango + bebida à escolha', price: 39.9, imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=70', featured: true, available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-combo-familia', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-combos', name: 'Combo Família', description: 'Carne de sol + 2 bebidas + sobremesa', price: 119.9, imageUrl: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-combo-lanche', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-combos', name: 'Combo Expresso', description: 'Prato do dia + café ou suco', price: 28.9, imageUrl: 'https://images.unsplash.com/photo-1562967914-608f82629710?w=600&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-combo-verde', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-combos', name: 'Combo Verde', description: 'Prato vegetariano + suco natural', price: 32.9, imageUrl: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=600&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  // Mais pedidos (mirror do bestsellers)
  { id: 'prod-mp-carne-de-sol', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-mais-pedidos', name: 'Carne de sol c/ aipim', description: 'Favorito da casa — sempre esgota', price: 78.9, imageUrl: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=70', featured: true, available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-mp-helado', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-mais-pedidos', name: 'Helado 1/4 kg', description: 'Sorvete artesanal — nº1 em pedidos', price: 22.0, imageUrl: 'https://images.unsplash.com/photo-1501443762994-82bd5dace89a?w=600&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-mp-mirante', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-mais-pedidos', name: 'Entrada Mirante', description: 'Mix de queijos, embutidos e pães', price: 42.0, imageUrl: 'https://images.unsplash.com/photo-1541529086526-db283c563270?w=600&q=70', available: true, createdAt: NOW, updatedAt: NOW },
  { id: 'prod-mp-frango-brasa', tenantId: TENANT_ID, branchId: BRANCH_ID, categoryId: 'cat-mais-pedidos', name: 'Frango na brasa', description: 'Grelhado na brasa — muito pedido', price: 55.0, imageUrl: 'https://images.unsplash.com/photo-1532550907401-a500c9a57435?w=600&q=70', available: true, createdAt: NOW, updatedAt: NOW },
];
